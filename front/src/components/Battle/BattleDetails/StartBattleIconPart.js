        ...
        <div className="first" style={{ display: "flex" }}>
          {battleArr.map((pokemon, idx) => (
            <div className="" key={idx}>
              <div
                className={
                  pokemon.name === firstPokemon.name ? "moveUpDown pp" : "pp"
                }
              >
                {firstPokemon.name === pokemon.name && (
                  <AiOutlineArrowDown
                    style={{
                      display: "flex",
                      position: "relative",
                ...
                <img
                  style={{
                    width: "5rem",
                    display: "flex",
                    filter: idx < myPokemons ? "saturate(0)" : "saturate(1)",
                  }}
                  alt="pokemon"
                  className=""
                  src={pokemon.icon}
      ...
      <div className="second" style={{ display: "flex", float: "right" }}>
        {battleArr.map((pokemon, idx) => (
          <div key={idx}>
            <div
              style={{
                filter: idx < rivalPokemons ? "saturate(0)" : "saturate(1)",
              }}
            >
              <img

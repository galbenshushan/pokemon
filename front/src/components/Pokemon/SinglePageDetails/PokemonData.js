  ...
  return (
    <div className="totalWrapper">
        ...
        <thead>
          ...
          {pokemonText.length !== 0 && (
            <tr style={dynamicText}>
              ...
              <td style={dynamicText} scope="col">
                <Description pokemon={pokemon.name} pokemonText={pokemonText} />
              </td>
            </tr>
          )}
          <tr style={dynamicText}>
          ...
          <tr style={dynamicText}>
            ...
            <td style={dynamicText} scope="col">
              {pokemon.height / 10} Meters / {meterToFeet(pokemon.height)} Feet
            </td>
          </tr>
          <tr style={dynamicText}>
            <th style={dynamicText} scope="col">
            ...
            <td style={dynamicText} scope="col">
              {numberWithCommas(pokemon.weight / 10)} Kg /{" "}
              {numberWithCommas((pokemon.weight / 10) * 2.2)} lbs
            </td>
          </tr>
          <tr style={dynamicText}>
            <th style={dynamicText} scope="col">
      ...
      <table style={dynamicText} className="first table tablee">
        <thead>
          <div className="">
            <h5 className="first" style={dynamicText}>
              Base Stats
            </h5>
          </div>
            ...
            <tr key={idx}>
              ...
              <td style={{ width: "12rem" }}>
                <div
                  style={{ width: "12rem" }}
                  className={
                    themeSlice === false ? "myProgressdark" : "myProgress"
                  }
                >
                  <div
                    className={themeSlice === false ? "myBardark" : "myBar"}
                    style={{ width: `${Math.ceil(stat.base_stat / 2.5)}%` }}
                  ></div>
                </div>
              </td>
              <td style={{ width: "5rem" }}>
                {Math.ceil(stat.base_stat * 2.5)}
              </td>
            </tr>
          ))}
          {happiness > 0 && (
            <tr>
              ...
              <td style={{ width: "12rem" }}>
                ...
                >
                  <div
                    className={themeSlice === false ? "myBardark" : "myBar"}
                    style={{ width: `${Math.ceil(happiness / 2.5)}%` }}
                  ></div>
                </div>
              </td>

...
const Evolution = ({ evolutionLineOne, evolutionLineTwo, evolutionLineThree, dynamicText }) => {

    const trioArr = [evolutionLineOne, evolutionLineTwo, evolutionLineThree]

    return (
        <div className='evolution-line'>
            {evolutionLineOne.length > 0 && <h5 className='header' style={dynamicText}>Evolution chart</h5>}

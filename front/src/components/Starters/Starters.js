...
const Starters = () => {
    ...
    const getDetails = () => {
        ...
        startersArr.forEach(async pokemon => {
            ...
            setStarterPokemons(current => [...current, { id, name, types, image, shinyImage, isShiny, icon, moves, stats, sprites, level }])
        });
    }
    ...
    return (
        <div>
            <h3 style={{ color: dynamicText, paddingTop: '1rem' }}>Choose your first Pokemon!</h3>
